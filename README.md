...
DEMO can be viewed here: https://www.bethculler.dev/demo/dashboard_demo_index.html
...
[tablespace_growth_trender.sh](https://github.com/bculler17/Oracle_Bash_Scripts/blob/main/scripts/trend_tablespace_growth/tablespace_growth_trender.sh)
